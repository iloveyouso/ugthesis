...
def start():
    ...
    parser.add_argument('--out_res', nargs='+', default=[512, 512], type=int,  help='Optional output resolution')
    parser.add_argument('--thresh', type=float, default=0.92, help='Optional threshold')
    ...
    if hypes['arch']['config'] == 'HRNet_do':
        ...
        bayesMethod = 'dropout'
    elif hypes['arch']['config'] == 'HRNet_bayes_all': # by bjkim
